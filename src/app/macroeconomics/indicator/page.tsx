...
export default function MacroeconomicsIndicatorPage() {
  return (
          ...
          <header className="sticky top-0 z-30 flex h-14 shrink-0 items-center gap-2 border-b bg-background/95 px-4 backdrop-blur supports-[backdrop-filter]:bg-background/80">
            ...
            <Breadcrumb>
              <BreadcrumbList>
                ...
                <BreadcrumbSeparator className="hidden md:block" />
                <BreadcrumbItem>
                  <BreadcrumbPage>Macroeconomics Indicator</BreadcrumbPage>
                </BreadcrumbItem>
              </BreadcrumbList>
            </Breadcrumb>
          ...
          <main className="flex min-w-0 flex-col gap-3 px-4 pb-4 pt-3">
            <div>
              ...
              <p className="text-sm text-muted-foreground">
                Key macroeconomic indicators and metrics will appear here.
              </p>
            </div>
          </main>
        </SidebarInset>
